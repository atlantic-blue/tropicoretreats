    ...
    <footer className="bg-gray-950 text-white" role="contentinfo" aria-label="Footer">
      ...
      <div className="mx-auto max-w-[1400px] px-4 py-16 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 gap-12 border-t border-white/10 pt-12 sm:grid-cols-2 lg:grid-cols-4">
          {/* Browse */}
          <div>
            <h3 className="mb-5 text-sm font-bold uppercase tracking-widest text-[#C9A227]">
              Browse
            </h3>
            <nav className="space-y-3">
              <Link
                to="/destinations/caribbean"
                className="block text-sm text-gray-300 transition-all hover:text-white hover:translate-x-1"
              >
                Caribbean
              </Link>
              <Link
                to="/destinations/casanare"
                className="block text-sm text-gray-300 transition-all hover:text-white hover:translate-x-1"
              >
                Casanare
              </Link>
              <Link
                to="/destinations/coffee-region"
                className="block text-sm text-gray-300 transition-all hover:text-white hover:translate-x-1"
              >
                Coffee Region
              </Link>
