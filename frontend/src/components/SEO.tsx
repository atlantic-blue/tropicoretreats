    ...
    itemListElement: [
      ...
      },
      {
        ...
        itemOffered: {
          ...
          name: 'Transport',
          description:
            'Airport transfers, internal transport, premium vehicles with bilingual drivers',
        },
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          name: 'Venues',
          description:
            'Conference rooms, outdoor spaces, meeting facilities with full AV equipment',
        },
      },
      {
        '@type': 'Offer',
        itemOffered: {
          ...
          name: 'Activities',
          description:
            'Team building, outdoor adventures, cultural experiences, wellness programmes',
        },
      },
      {
        '@type': 'Offer',
